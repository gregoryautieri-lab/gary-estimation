...
import { ChevronLeft, ChevronRight, Calendar, Mail, ClipboardList } from 'lucide-react';
...
export default function PlanningProspection() {
  ...
  const { data: missions = [], isLoading } = usePlanningMissions({ weekStart: currentWeekStart });
