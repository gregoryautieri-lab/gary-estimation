/**
 * Bibliothèque d'icônes SVG style Lucide pour le PDF GARY
 * Ligne fine, minimaliste - exactement comme le fichier source
 */

// Tous les paths SVG extraits du fichier original
...
/**
 * Génère une icône SVG inline pour le PDF
 * @param name - Nom de l'icône
 * @param size - Taille en pixels (défaut: 20)
 * @param color - Couleur stroke (défaut: #64748b)
...
// Export des noms d'icônes disponibles pour autocomplétion
export type IconName = keyof typeof iconPaths;
export const availableIcons = Object.keys(iconPaths) as IconName[];
